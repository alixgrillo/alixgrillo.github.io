...
$(document).ready(function() {
  ...
  $(".btn").click(function() {
    switch (this.id) {
      case "download":
        window.open("assets/documents/cv-Alexandra_Clare.pdf");
        break;
      case "github":
        window.open("https://github.com/alixgrillo");
        break;
      case "linkedin":
        window.open("https://www.linkedin.com/in/alixclare/");
        break;
      case "hireme":
...
$(document).on("click", ".more-info", function(event) {
  var tech = $(this).attr("data-id");
  console.log(tech);
  console.log(moreInfo[tech]);
  $("#moreInfoTitle").text(moreInfo[tech].title);
  $("#moreInfoList").empty();
  moreInfo[tech].skills.forEach(element => {
    $("#moreInfoList").append("<li>" + element + "</li>");
  });
  $("#moreInfo").modal("open");
});
